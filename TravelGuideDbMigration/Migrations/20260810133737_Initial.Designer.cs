...
namespace TravelGuideDbMigration.Migrations
{
    ...
    [Migration("20260810133737_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelGuideDbModels.CategoryModel", b =>
                {
            ...
            modelBuilder.Entity("TravelGuideDbModels.PlaceByCategory", b =>
                {
                    b.Property<int>("PlaceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelGuideDbModels.PlaceByCategory", b =>
                {
                    b.HasOne("TravelGuideDbModels.CategoryModel", "CategoryNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("TravelGuideDbModels.PlaceByTag", b =>
                {
                    ...
                    b.HasOne("TravelGuideDbModels.TagModel", "TagNavigation")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
